      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-9 leading-tight pt-10"
          >
            Find Your Dream Job or
            <span className="block bg-gradient-to-r from-blue-600 to-purple-400 bg-clip-text text-transparent mt-2">
              Perfect Hire
            </span>
          </motion.h1>
          {/*Subheading*/}
          <motion.p
            ...
            className="text-xl md:text-xl text-gray-600 mb-12 max-w-xl mx-auto leading-relaxed"
          >
            Connect talented professionals with innovative companies. Your next
            career move or prefect candidate is just one click away.
          </motion.p>
          {/*CTA Button*/}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group bg-gradient-to-r from-blue-600 to-purple-400 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-500 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
