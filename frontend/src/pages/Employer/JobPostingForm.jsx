...
const JobPostingForm = () => {
  ...
  return (
    <DashboardLayout activeMenu='post-job'> 
    <div className="min-h-scren bg-gradient-to-br from-slate-50 via-blue-50/30 to-puprle-50/20 py-8 px-4 sm:px-6 lg:px-8">
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <SelectField 
      ...
      JonChange={(e) => handleInputChange("jobType", e.target.value)}
      options={JOB_TYPES}
      ...
      <div className="space-y-2">
        ...
        className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-pffset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed outline-none transition-colors duration-200"
      >
      {isSubmitting ? (
        <>
