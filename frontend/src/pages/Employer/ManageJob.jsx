...
const ManageJob = () => {
  ...
  //Decide which sort icon todisplay based on current sort field and direction
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from to-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-sm text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue500/30 transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="sm:w-48">
                <select
                  ...
                  className="block w-full px-4 pr-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200"
                >
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-[1800px] sm:min-w-0">
                          Actions
                        </th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {isLoading
                        ? Array.from({ lemgth: 5 }).map((_, index) => (
            ...
            <div className="mt-6 flex items-center justify-between">
              <div className="flex-1 flex justify-between sm:hidden">
                ...
                <button
                  ...
                  className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-grray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >Next</button>
              </div>
