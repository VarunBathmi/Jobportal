...
const JobPostingPreview = ({ formData, setIsPreview }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="">
            ...
            <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-0">
                  ...
                  {user?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="h-16 md:h-20 object-cover rounded-2xl border-4 border-white/20 shadow-lg"
                    />
                  ) : (
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                  <span className="px-4 py-2 bg-blue-50 text-sm text-blue-700 font-semibold rounded-full border-blue-200">
                    {
                      CATEGORIES.find((c) => c.value === FormData.category)
                        ?.label
                    }
                  </span>
                  <span className="px-4 py-2 text-sm bg-purple-50 text-purple-700 font-semibold rounded-full border-purple-200">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                ...
                <div className="hidden md:flex items-center space-x-2 text-sm text-emarald-700 bg-emerald-100 px-3 py-1 rounded-full">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-xl p-6">
                  <div className="text-s text-gray-700 leading-relaxed whitespace-pre-wrap">
