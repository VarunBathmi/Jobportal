...
const DashboardLayout = ({ activeMenu, children }) => {
  ...
  const sidebarCollapsed = false; // simple for now
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            className="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-500 transition-all duration-200"
            onClick={logout}
          >
